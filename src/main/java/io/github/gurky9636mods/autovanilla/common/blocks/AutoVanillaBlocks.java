...
public class AutoVanillaBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(AutoVanillaMod.MOD_ID);
    ...
    public static final DeferredRegister<MapCodec<? extends Block>> BLOCK_TYPES = DeferredRegister.create(Registries.BLOCK_TYPE, AutoVanillaMod.MOD_ID);
